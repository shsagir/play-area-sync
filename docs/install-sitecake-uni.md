...
template:         article
reviewed:         2017-06-06
title:            Install Sitecake
naviTitle:        Sitecake
lead:             "Sitecake is a new, free, file based CMS with on-site 'drag and drop' editing features."
...
websiteLink:      https://sitecake.com?utm_source=fortrabbit
websiteLinkText:  getgrav.org
category:         CMS
image:            sitecake-logo.png
stack:            uni
...
We assume you've already created an [App](app) and chose general PHP. If not: You can do so in the [fortrabbit Dashboard](/dashboard).
