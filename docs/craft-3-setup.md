...
[Change ENV vars with your App: **{{app-name}}**](https://dashboard.fortrabbit.com/apps/{{app-name}}/vars)
</div>
...
This can easily be done with [Craft Copy Plugin](https://github.com/fortrabbit/craft-copy) we developed for this purpose. Follow these steps:
