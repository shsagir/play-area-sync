...
This article is about the deployment file version 1, which is used by [Old Apps](app-old). [Version 2](deployment-file-v2) is used by the Professional & Universal Apps.
